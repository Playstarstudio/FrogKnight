...
public class InventoryManager : MonoBehaviour
{
    ...
    private void PrepareUI()
    {
        ...
        this.onDescriptionRequested += HandleDescriptionRequest;
        this.OnSwapItems += HandleSwapItems;
        this.OnStartDragging += HandleStartDragging;
        this.OnItemActionRequested += HandleItemActionRequest;
    }
